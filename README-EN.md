...
| **9/25 (Fri)** | Alishan ➔ Tainan | **Sunrise & Ancient Capital:** Early morning Zhushan Line train for sunrise; midday descend to Chiayi for turkey rice lunch; afternoon transfer to Tainan. | Small train + Bus + HSR/TRA | West Central Dist., Tainan | **Tickets:** Buy the sunrise forest train ticket before 4 PM the day before at Alishan Station. |
...
## 🐘 Day 1 Highlight: Elephant Mountain (Xiangshan) — Iconic Taipei 101 Photo

Your friend's recommendation is spot on! Elephant Mountain offers THE classic postcard view of Taipei 101. Only a 15-20 minute hike to the top — super easy!
...
- **📍 Nearby:** Elephant Mountain is right next to Taipei 101/Xinyi Shopping District — only a 15-min walk from the base to 101. Can combine with Taipei 101 Observatory visit
- **🍜 Nearby Night Market:** Tonghua Night Market (Linjiang Street) — 25-30 min walk from the base, or 2 MRT stops to Xinyi Anhe station. Or head back to the city for Ningxia Night Market

> **💡 Tip:** You're arriving on a red-eye flight at 6:15 AM. Drop bags at the hotel, rest/sleep until 3-4 PM, then head to Elephant Mountain — perfect timing for sunset!

---

## 🔑 Day 2 Highlight: Yangmingshan Chinese Culture University Night View

Chinese Culture University is located on Yangmingshan in northern Taipei — the same direction as the National Palace Museum (in Shilin District), so it's perfectly on the way.

- **🌅 Morning:** National Palace Museum — explore Chinese cultural treasures (~3 hours)
- **☕ Afternoon:** Dadaocheng/Dihua Street — old Taipei vintage vibe, hand-drip coffee in renovated heritage cafés
- **🌃 Evening:** Yangmingshan, Lover's Hill behind Chinese Culture University — unobstructed panoramic view of the entire Taipei Basin, with Taipei 101 in sight

**🍽️ Landscape Restaurant Recommendations (below Lover's Hill, built into the mountainside):**
| Restaurant | Highlights |
|---|---|
| **The Top (屋顶上)** | One of Taipei's most famous night-view restaurants, Bali-style tropical resort vibe with open-air sofa seating. No reservations — walk-in only, expect a queue. |
| **Sleepless in Yangmingshan (草山夜未眠)** | Equally stunning views, romantic seating, Taiwanese stir-fry + Western dishes, very relaxed atmosphere. |

**🚗 Transport:**
- **Going up:** After Dadaocheng, take an Uber directly (set destination to "Lover's Hill behind Chinese Culture University" or a specific restaurant), ~30-40 min. Alternatively, take MRT to "Jiantan Station" then bus "Red 5" direct to the university — follow the students.
- **Coming down:** Ask the restaurant front desk to call a taxi, or use Uber. You can stop by Shilin Night Market for a late-night snack on the way down.
...
| Purpose | App |
|---|---|
| Transport | Taiwan High Speed Rail (T Express), Taiwan Railway (台铁e订通), Uber, Google Maps |
| Restaurant Booking | inline App (for Michelin-recommended/popular restaurants like Tainan's A-Hsia Restaurant) |

### ⏰ Crucial Booking Timelines
| Timeline | What to Book | Corresponding Date |
|---|---|---|
...
- **For exploring:** Stay near Fuzimiao/Qinhuai River area — explore Confucius Temple, Qinhuai River scenic belt in the afternoon/evening, try Nanjing salted duck & duck blood vermicelli soup

---

> 📌 *This itinerary combines Mafengwo travel guide insights (ref. Mafengwo self-guided tour guide #220075) and a friend's on-the-ground recommendation. All transportation info has been fact-checked for 2026. Elephant Mountain info sourced from GuideToTaipei.com. The original Mafengwo link requires JavaScript rendering and could not be programmatically accessed — common Taiwan round-island travel guide insights have been incorporated instead.*
